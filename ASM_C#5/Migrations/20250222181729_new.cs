    ...
    public partial class @new : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComboItems", x => x.ComboID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComboDetails", x => new { x.FoodID, x.ComboID });
                    table.ForeignKey(
                        name: "FK_ComboDetails_ComboItems_ComboID",
                        column: x => x.ComboID,
                        principalTable: "ComboItems",
                        principalColumn: "ComboID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComboDetails_FoodItems_FoodID",
                        column: x => x.FoodID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_ComboItems_ComboID",
                        column: x => x.ComboID,
                        principalTable: "ComboItems",
                        principalColumn: "ComboID",
                        onDelete: ReferentialAction.Restrict);
